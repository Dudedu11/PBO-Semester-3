...
public class Staff {
    ...
    public Staff (){
        ...
        staffList[6] = new Commission("Dudedu", "567 Newyork Street", "123-321",
                "123-45-6788", 6.25, 6.25*0.2);
        staffList[7] = new Commission("John", "123 Swiss Street", "111-1234",
                "987-54-4321", 9.75,9.75*0.15);
